...
namespace App
{
    public abstract class UniversitySearchFormManager : BaseFormManager
    {
        ...
        protected UniversitySearchFormManager(IDataManipulations dataManipulations) : base(dataManipulations)
        {
