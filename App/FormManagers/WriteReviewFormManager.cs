...
namespace App
{
    public abstract class WriteReviewFormManager : BaseFormManager
    {
        ...
        protected WriteReviewFormManager(IDataManipulations dataManipulations) : base(dataManipulations)
        {
